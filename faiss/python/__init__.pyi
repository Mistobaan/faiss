...
def get_index_ptr(index: Index) -> int: ...
def adopt_index_ptr(x: int) -> Index: ...
def get_index_ptr(index: Index) -> int: ...
def adopt_index_ptr(x: int) -> Index: ...
...
class MetalIndexTurboQuantMSE(Index):
    @overload
    def __init__(
        self,
        provider: StandardMetalResources,
